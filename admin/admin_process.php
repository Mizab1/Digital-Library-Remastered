<?php
    ...
    if (isset($_POST["save"])) {
        ...
        mysqli_query($connectdb, "INSERT INTO book (book_name, auth_name, pages, pdf_add) VALUES('$book_name', '$auth_name', '$pages', '$location')");
    ...
    //     mysqli_query($connectdb, "UPDATE book SET book_name='$book_name', auth_name='$auth_name', pages='$pages' WHERE id=$id");
